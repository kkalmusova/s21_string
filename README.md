...
Реализация собственной версии библиотеки string.h на языке Си.

## О проекте

В данном проекте была разработана собственная реализация библиотеки string.h на языке программирования Си с некоторыми дополнениями (с собственной реализацией функции sprintf и некоторыми функциями для обработки строк из языке C#).
